...
⚠️ **THINK HARD** - Use extended thinking for all code analysis
...
1. Read all relevant docs related to the plan/executed code. These would be files such as:
- SPEC files
- PLAN files
- EXECUTED files
- code-graph generated files
     - ARCHITECTURE docs
     - FILE_STRUCTURE docs
     - Contracts docs
