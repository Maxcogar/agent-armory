...
1. **Read the AgentBoard skill** to understand the full workflow:
   - Read `.claude/skills/agentboard/SKILL.md`
   - Read `CLAUDE.md` for codebase constraints
...
8. **Inform the user**: "Setup complete. I'll now begin working on the first task. When you need a new agent to continue, use `/pickup`."
