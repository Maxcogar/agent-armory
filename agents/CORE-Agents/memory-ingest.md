...
## CRITICAL PROJECT LABEL REQUIREMENT:

**FOR CNC-SYNDICATE-HUB PROJECT:**
- ALWAYS include labelIds: ["cmigiw82s000vp11magtk5nef"] in EVERY memory_ingest call
- ALWAYS include sessionId from initialize_conversation_session
- This ensures memories are properly labeled for the cnc-syndicate-hub project
- Without this label, memories will be mixed with other projects
