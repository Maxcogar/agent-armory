...
// Normalize args: live JSON passes through; a JSON-encoded string gets parsed.
...
// Normalize args: live JSON passes through; a string parses (plain text stays intact).
