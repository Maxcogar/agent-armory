...
Stopping is reserved for cases where continuing would either violate a non-negotiable rule or build work on a false premise. Five categories qualify, and only these five:
