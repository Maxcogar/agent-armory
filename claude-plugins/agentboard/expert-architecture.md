...
1\. `mcp\_\_claude\_ai\_Context7\_\_resolve-library-id` — pass the library name; receive a Context7-compatible library ID.

2\. `mcp\_\_claude\_ai\_Context7\_\_query-docs` — pass the library ID and a specific question (the behavior, API, or pattern you need to verify). Read the returned content.
