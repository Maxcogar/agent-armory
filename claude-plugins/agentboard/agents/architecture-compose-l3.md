...
**(c) Field ingestion.** Treat the resolved bundle as authoritative ground truth on the codebase. Ingest the bundle by reading each of the following fields in turn:
